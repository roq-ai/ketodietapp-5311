...
import { getDietitians } from 'apiSdk/dietitians';
...
function DashboardPage() {
  ...
  const dietitianStat = useSWR<PaginatedInterface<DietitianInterface>>(
    () => `/dietitians`,
    () => getDietitians({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      title: 'Dietitians',
      result: dietitianStat?.data?.totalCount,
      isLoading: dietitianStat.isLoading,
