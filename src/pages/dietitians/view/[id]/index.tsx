...
import { getDietitianById } from 'apiSdk/dietitians';
import { DietitianInterface } from 'interfaces/dietitian';

function DietitianViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('dietitian', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/dietitians/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Availability"
                  text={
                    data?.availability ? format(parseISO(data?.availability as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
