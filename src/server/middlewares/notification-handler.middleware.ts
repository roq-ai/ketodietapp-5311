...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A new diet plan has been created by a customer..create': {
    roles: ['tenant-roles', 'tenant-owner-roles'],
    key: 'diet_plan',
    tenantPath: [],
    userPath: [],
  },
  'A dietitian has updated a diet plan..update': {
    roles: ['tenant-roles'],
    key: 'diet_plan',
    tenantPath: [],
    userPath: [],
  },
  'A customer has submitted feedback..create': {
    roles: ['tenant-roles', 'tenant-owner-roles'],
    key: 'feedback',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['business-owner', 'dietitian'];
