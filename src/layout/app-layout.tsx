...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'dietitian'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Dietitians', path: '/dietitians', entity: 'dietitian', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Menus', path: '/menus', entity: 'menu', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Schedules', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Subscriptions',
      path: '/subscriptions',
      entity: 'subscription',
