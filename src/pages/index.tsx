...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`KetoDietApp`}</title>

        <meta
          name="description"
          content="Unleash the power of your diet with KetoDietApp, your one-stop platform for scheduling daily, weekly, and monthly Keto menus. Seamless payment and subscription system included."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1542814880-7e62cf14b7c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxrZXRvJTIwZGlldHxlbnwwfHx8fDE2OTU0MTM2MTV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@nadineprimeau?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nadine Primeau`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of your diet with KetoDietApp, your one-stop platform for scheduling daily, weekly, and monthly Keto menus. Seamless payment and subscription system included.`}
            </Text>
            <Box
