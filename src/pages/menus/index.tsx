...
export function MenuListPage(props: MenuListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMenus({
        relations: [, 'schedule.count', 'subscription.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'protein', header: 'protein', accessorKey: 'protein' },
    { id: 'carbs', header: 'carbs', accessorKey: 'carbs' },
    { id: 'fat', header: 'fat', accessorKey: 'fat' },
    ...
    hasAccess('subscription', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.subscription,
        }
      : null,
